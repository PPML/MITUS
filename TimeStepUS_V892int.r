...
//////////////////////////////////////////////////////////////////////////////// 
    for(int ag=0; ag<11; ag++) {
      V0[ag][0][0][0][0][0] = InitPopN[ag][0]*0.40*(1-p_HR); 
      V0[ag][0][0][0][0][1] = InitPopN[ag][0]*0.40*p_HR; 
      V0[ag][0][0][0][0][3] = InitPopN[ag][1]*0.40;
      V0[ag][2][0][0][0][0] = InitPopN[ag][0]*0.60*(1-p_HR); 
      V0[ag][2][0][0][0][1] = InitPopN[ag][0]*0.60*p_HR; 
      V0[ag][2][0][0][0][3] = InitPopN[ag][1]*0.60;  }
