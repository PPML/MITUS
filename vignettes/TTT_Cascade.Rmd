...
params<-param_init(Par[3,], loc = "US", prg_chng=def_prgchng(Par[3,]), ttt_list=def_ttt())
...
model_load()
Par<-readRDS("~/MITUS/inst/US/US_Param_all_10_1031.rds")
params2<-param_init(Par[3,], loc = "US", prg_chng=def_prgchng(Par[3,]), ttt_list=risk_pop_setup()[[1]])
