...
prms <-list()
prms <- fin2_param(P,loc,prg_chng, ttt_list = def_ttt())
...
zz <- fin2_cSim( nYrs       = 2018-1950         , nRes      = length(func_ResNam())  , rDxt     = prms[["rDxt"]]  , TxQualt    = prms[["TxQualt"]]   , InitPop  = prms[["InitPop"]]    ,
