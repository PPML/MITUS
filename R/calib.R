...
# P[["ImmigVol"]]<-1.1
  ...
  trans_mat_tot_ages<<-reblncd(mubt = prms$mubt,can_go = can_go,RRmuHR = prms$RRmuHR[2], RRmuRF = prms$RRmuRF, HRdist = HRdist, dist_gen_v=mort_v, adj_fact=prms[["adj_fact"]])
