model_calib_outputs<-function(loc="US",samp_i=1){
  ...
  V <- V[,1]/rowSums(V)*100
  saveRDS(V,file = paste0("~/MITUS/inst/",loc,"/calibration_outputs/",loc,"_percentRecentFBcases_07-18-19.rds"))
  ...
  saveRDS(txoutcomes,file = paste0("~/MITUS/inst/",loc,"/calibration_outputs/",loc,"_txOutcomes_07-18-19.rds"))
