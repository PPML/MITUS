...
results<-readRDS(system.file(paste0(loc,"/sm_resTab_2019-05-06.rds"), package="MITUS"))
...
results<-readRDS(system.file(paste0(loc,"/bg_resTab_2019-05-06.rds"), package="MITUS"))
#make an empty restab
