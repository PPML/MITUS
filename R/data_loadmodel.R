...
#'Model Input
if (loc=="US"){
  CalibDat<<-readRDS(system.file("US/US_CalibDat_05-10-20.rds", package="MITUS"))
  ...
  CalibDat<<-CalibDatState<<-readRDS(system.file("ST/ST_CalibDat_04-27-20.rds", package="MITUS"))
