...
#'Model Input
if (loc=="US"){
  CalibDat<<-readRDS(system.file("US/US_CalibDat_05-18-20.rds", package="MITUS"))
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_2020-04-28.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2020-04-28.rds", package="MITUS"))
  ...
  CalibDat<<-CalibDatState<<-readRDS(system.file("ST/ST_CalibDat_05-12-20.rds", package="MITUS"))
