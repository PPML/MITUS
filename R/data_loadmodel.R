...
if (loc=="US"){
  ...
  Opt<<-readRDS(system.file("US/US_Optim_all_10_0511.rds", package="MITUS"))

} else {
  CalibDat<<-CalibDatState<<-readRDS(system.file("ST/ST_CalibDat_05-12-20.rds", package="MITUS"))
  ParamInit_st<<-ParamInit<<-readRDS(system.file("ST/ST_ParamInit_2020-05-12.rds", package="MITUS"))
