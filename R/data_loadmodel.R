...
if (loc=="US"){
  ...
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_04-23-20.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2020-04-23.rds", package="MITUS"))
