...
if (loc=="US"){
  ...
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_2020-06-11.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2020-06-11.rds", package="MITUS"))
