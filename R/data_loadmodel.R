...
if (loc=="US"){
  ...
  CalibDat<<-CalibDatState<<-readRDS(system.file("ST/ST_CalibDat_10-28-21.rds", package="MITUS"))
  ...
  Inputs<<-readRDS(system.file(paste0(loc,"/",loc,"_ModelInputs_10-06-21.rds"), package="MITUS"))
