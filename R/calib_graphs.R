...
#CREATES A VECTOR OF THE PARAMETERS
source("R/define_P.R")

############ LOAD IN THE MODEL INPUTS
load("data/ModelInputs_9-2-16.rData")
############ FORMAT THE PARAMETERS
source("R/param.R")

source("R/PriorFunc.R")

source("R/CalibFunc.R")
#####SOURCE IN THE MODEL CODE FROM C++
...
#LOAD OPTIMIZED PARAMETERS DATA SET
load("data/Opt_US5401_r8_1_1-27-16.rData")

###### unclear what this code is doing
o10
par_1 <- o10$par
...
write.csv(cbind(ParamInit,P,reldens2),file=paste("Parameter_table", Sys.time(), sep="_"))

source("R/param.R")


####### CREATE A PDF OF VARIOUS GRAPHS TO CHECK THE OUTPUT

pdfnam <- paste("Fig_Calib_Checks", Sys.time(), sep="_")
