...
tb_graph_demo <- function(df){
  ...
  plot(0,0,ylim=c(0,max(range(rowSums(V)))),xlim=c(1993,2014),xlab="",ylab="",axes=F)
  axis(1);axis(2,las=2);box()
  abline(h=axTicks(2),col="grey85")
  ...
  lines(1993:2014,V[,2],lwd=2,col="red3")
  lines(1993:2014,V[,1],lwd=2,col="blue")
  lines(1993:2014,rowSums(V),lwd=2,col="grey50")
  ...
  mtext("Risk Group",1,2.5,cex=0.9)
  box()
  mtext("Mortality by TB Progression Group for FB (red) and US (blue), 2014 (mil, log-scale)",3,.8,font=2,cex=0.8)
  legend("topright",c("Reported data","Fitted model"),pch=c(19,15),pt.cex=c(1,2),
         lwd=NA,col=c("grey30","grey80"),bg="white")
  ...
  mtext("Risk Group",1,2.5,cex=0.9)
  box()
  mtext("Mortality by Mortality Group for FB (red) and US (blue), 2014 (mil, log-scale)",3,.8,font=2,cex=0.8)
  legend("topright",c("Reported data","Fitted model"),pch=c(19,15),pt.cex=c(1,2),
         lwd=NA,col=c("grey30","grey80"),bg="white")
