...
# Motivation: norm, mean centered with CI = +/- 5% of mean
  ...
  notif_tot_lLik_st <- function(V) { # V = vector of total notifications 1993-2016
  ...
  notif_age_us_lLik_st <- function(V,rho=0.015) { # V = table of us notifications by age 1993-2016 (row=24 years, col=11 ages)
...
### ### ### FB CASES AGE DISTRIBUTION 1993-2016  ### ### ### ### ### ### D
  ...
  notif_age_fb_lLik_st <- function(V,rho=0.015) { # V = table of fb notifications by age 1993-2013 (row=21 years, col=11 ages)
    V2 <- V[,-11]; V2[,10] <- V2[,10]+V[,11]
...
# Motivation: dirichlet-multinomial, multinomial data with additional non-sampling biases
  ...
  notif_fb_lLik_st <- function(V,rho=0.005) { # V = table of notifications by fb 1993-2016 (row=24 years, col=fb then us)
...
### ### ### CASES FB DISTRIBUTION SLOPES OVER PAST 5 year  ### ### ### ### ### ### D
  ...
  notif_fbus_slp_lLik_st <- function(V) { # V = table of notifications by fb 2011-2016 (row=6 years, col=fb then us)
  ...
  notif_us_hr_lLik_st <- function(V,rho=0.005) { # V = table of notifications by tx history (row=97:16, col=n then e)
...
# Motivation: dirichlet-multinomial, multinomial data with additional non-sampling biases
  ...
  tx_outcomes_lLik_st <- function(V,rho=0.01) { # V = table of treatment outcomes 1993-2012 (row=20 years, col= complete, discontinue, dead)
...
# Motivation: norm, mean centered with CI = +/- 10% of mean
  ...
  tltbi_tot_lLik_st   <- function(V) { # V = total TLTBI inits in 2002 (scalar)
...
### ### ### DISTRIBUTION OF LTBI TREATMENT INITS 2002  ### ### ### ### ### ###  D
  ...
  tltbi_dist_lLik_st  <- function(V) { # V = dist TLTBI inits in 2002 (vector fraction FB, HR, HV in 2002)
...
# Motivation: norm, mean centered with CI = +/- 2 million wts[1+0:6*10]
  ...
  tot_pop_yr_fb_lLik_st <- function(V) { # V = total pop (rows=year, cols=us, fb)
  ...
  tot_pop_yr_us_lLik_st_00_10 <- function(V) { # V = total pop (rows=year, cols=us, fb)
...
# Motivation: reported estimates represent pseudo-data for a multinomial likelihood, with ESS = 500
  ...
  tot_pop14_ag_fb_lLik_st <- function(V,ESS=500) { # V =  US pop in 2014 (row=11 ages, col= us, fb)
  ...
  homeless_10_lLik_st <- function(V) { # V = homeless pop in 2010 (scalar)
