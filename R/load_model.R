...
if (loc=="US"){
  ...
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_2019-08-05.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2019-08-05.rds", package="MITUS"))
