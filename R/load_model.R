...
if (loc=="US"){
  ...
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_2019-08-06.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2019-08-06.rds", package="MITUS"))
  ...
  ParamInit_st<<-ParamInit<<-readRDS(system.file("ST/ST_ParamInit_2019-08-02.rds", package="MITUS"))
  StartVal_st<<-StartVal<<-readRDS(system.file("ST/ST_StartVal_2019-08-02.rds", package="MITUS"))
