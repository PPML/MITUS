...
if (loc=="US"){
  ...
  ParamInit_st<<-ParamInit<<-readRDS(system.file("ST/ST_ParamInit_2019-07-10.rds", package="MITUS"))
  StartVal_st<<-StartVal<<-readRDS(system.file("ST/ST_StartVal_2019-07-10.rds", package="MITUS"))
