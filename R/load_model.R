...
if (loc=="US"){
  ...
  ParamInit<<-as.data.frame(readRDS(system.file("US/US_ParamInit_2019-09-06.rds", package="MITUS")))
  StartVal<<-readRDS(system.file("US/US_StartVal_2019-09-06.rds", package="MITUS"))
